...
export default function Newsletter() {
  ...
  return (
    <section className="my-10 rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 px-5 py-12 text-center text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500 rounded-full blur-3xl opacity-20 -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="relative z-10 max-w-lg mx-auto">
        ...
        <p className="text-blue-100 text-sm sm:text-base mb-7 leading-relaxed">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            className="px-6 py-3 bg-white text-blue-700 font-bold text-sm rounded-xl hover:bg-blue-50 transition-colors shadow-lg flex-shrink-0"
          >
            Subscribe →
          </button>
        </form>
