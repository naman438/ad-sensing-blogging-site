...
export default async function BlogPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">All Articles</h1>
      <p className="text-gray-500 text-sm sm:text-base mb-8">Fresh insights published daily across multiple topics.</p>
